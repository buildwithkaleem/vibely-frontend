        ...
        <div className="mt-10 space-y-10 rounded-2xl border bg-white p-8 shadow-sm">
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6 leading-8 text-gray-600">
              ...
              <li>TikTok account information after your authorization.</li>

              <li>
                Public profile information such as your display name, username,
                and profile picture.
              </li>
              ...
              <li>
                Technical information required for security and performance.
              </li>
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6 leading-8 text-gray-600">
              ...
              <li>Upload videos that you explicitly choose to publish.</li>

              <li>Provide account management features.</li>
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6 leading-8 text-gray-600">
              ...
              <li>Withdraw authorization at any time.</li>
